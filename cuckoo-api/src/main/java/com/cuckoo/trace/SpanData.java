...
import com.cuckoo.resources.Resource;
import com.cuckoo.trace.Span.Kind;
...
public abstract class SpanData {
    ...
    /**
     * Returns the parent {@code SpanId} or {@code null} if the {@code Span} is a root
     *      {@code Span}.
     *
     * @return the parent {@code SpanId} or {@code null} if the {@code Span} is root
     *      {@code Span}.
     */
    @Nullable
    ...
    /**
     * Returns links records for this {@code Span}.
     *
     * @return links records for this {@code Span}.
     */
    ...
    /**
     * A immutable implementation of the {@link com.cuckoo.trace.Event}.
     *
     * @since 0.0.1
     */
    @Immutable
    @AutoValue
    public abstract static class Event implements com.cuckoo.trace.Event {
        private static final Map<String, AttributeValue> EMPTY_ATTRIBUTE =
            Collections.unmodifiableMap(Collections.emptyMap());

        /**
         * Returns a new {@code Event} with the given {@code name}.
         *
         * @param name the text name of the {@code Event}.
         * @return a new {@code Event} with the given {@code name}.
         * @throws NullPointerException if {@code name} if {@code null}.
         */
        public static com.cuckoo.trace.Event create(String name) {
            return new AutoValue_SpanData_Event(name, EMPTY_ATTRIBUTE);
        }
         ...
         */
        public static com.cuckoo.trace.Event create(
    ...
    public abstract static class Timestamp {
        ...
        public static Timestamp create(long seconds, int nanos) {
            ...
            if (seconds > MAX_SECONDS) {
                throw new IllegalArgumentException(
                    "'seconds' is less than maximum (" + MAX_SECONDS + "):" + seconds);
            }
            if (nanos < 0) {
        ...
        private static long floorDiv(long x, long y) {
            return BigDecimal.valueOf(x)
                .divide(BigDecimal.valueOf(y), 0, RoundingMode.FLOOR)
                .longValue();
        }

        // Return the floor modules "x - (floorDiv(x, y) * y"
