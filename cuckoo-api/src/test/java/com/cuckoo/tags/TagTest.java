...
public final class TagTest {
    ...
    private static final TagKey KEY_2 = TagKey.create("KEY_2");
    ...
    public void testGetKey() {
        assertThat(Tag.create(KEY, VALUE, METADATA_UNLIMITED_PROPAGATION).getKey())
            .isEqualTo(KEY);
    }

    @Test
    public void testTagMetadata() {
        assertThat(Tag.create(KEY, VALUE, METADATA_NO_PROPAGATION).getTagMetadata())
            .isEqualTo(METADATA_NO_PROPAGATION);
    }

    @Test
    public void testGeyValue() {
        assertThat(Tag.create(KEY, VALUE, METADATA_UNLIMITED_PROPAGATION).getValue())
            .isEqualTo(VALUE);
    }
